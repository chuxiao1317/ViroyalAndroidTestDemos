package com.chuxiao.preferencefragmenttest;
...
import com.chuxiao.preferencefragmenttest.audioVisualView.AudioInputReader;
import com.chuxiao.preferencefragmenttest.audioVisualView.VisualizerView;
...
public class MainActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void defaultSetup() {
        ...
        mVisualizerView.setShowBass(
                // true & false
                sharedPreferences.getBoolean(getString(R.string.pref_show_bass_key), true)
        );
        // 中音区
        mVisualizerView.setShowMid(
                // true & false
                sharedPreferences.getBoolean(getString(R.string.pref_show_mid_key), true)
        );
        // 高音部
        mVisualizerView.setShowTreble(
                // true & false
                sharedPreferences.getBoolean(getString(R.string.pref_show_treble_key), true)
        );
        ...
        mVisualizerView.setColor(
                sharedPreferences.getString(
                        getString(R.string.pref_color_key),// 从缓存读取
                        getString(R.string.pref_color_red_value))// 默认值
        );
        // 注册偏好设置监听器
...
//        }
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            // 设置颜色
            mVisualizerView.setColor(
                    sharedPreferences.getString(key, getString(R.string.pref_color_red_value)));
