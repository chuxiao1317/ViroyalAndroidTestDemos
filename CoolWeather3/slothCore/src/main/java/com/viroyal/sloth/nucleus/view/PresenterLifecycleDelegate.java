...
import com.viroyal.sloth.nucleus.factory.PresenterStorage;
...
public final class PresenterLifecycleDelegate<P extends Presenter> {
     ...
     */
    public void onDropView(boolean isNeedFinished) {
        if (presenter != null && presenterHasView && !isNeedFinished) {
            presenter.dropView();
