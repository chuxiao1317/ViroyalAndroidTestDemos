package com.viroyal.sloth.widget.filterview;
...
import com.viroyal.sloth.widget.AutoLineFeedViewGroup;
...
public class FilterView extends AutoLineFeedViewGroup implements View.OnClickListener {
    ...
    private TextView getTextViewTitle(FilterData filterData, int textSize, int textColor) {
        ...
        textView.setWidth(ScreenUtils.getScreenWidth(getContext()) - DensityUtil.dip2px(getContext(), 90));
        textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
        textView.setTextColor(textColor);
