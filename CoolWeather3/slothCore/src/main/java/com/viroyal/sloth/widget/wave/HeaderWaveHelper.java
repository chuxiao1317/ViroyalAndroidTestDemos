package com.viroyal.sloth.widget.wave;
...
public class HeaderWaveHelper {
    ...
    public HeaderWaveHelper(HeaderWaveView HeaderWaveView, int behindWaveColor, int frontWaveColor, float d) {
        mHeaderWaveView = HeaderWaveView;
        mHeaderWaveView.setWaveColor(behindWaveColor,frontWaveColor);
        mDefaultWaterLevelRatioF = d;
        mDefaultWaterLevelRatioT = d;
        initAnimation();
    }

    public HeaderWaveHelper(HeaderWaveView HeaderWaveView, int behindWaveColor, int frontWaveColor, float d, View view) {
        mHeaderWaveView = HeaderWaveView;
        mHeaderWaveView.setWaveColor(behindWaveColor,frontWaveColor);
        mFloatView = view;
        mDefaultWaterLevelRatioF = d;
    ...
    private void initAnimation() {
        ...
        final ObjectAnimator waterLevelAnim = ObjectAnimator.ofFloat(
                mHeaderWaveView, "waterLevelRatio", 1f, mDefaultWaterLevelRatioT);
...
//                mFloatView.setRotation(value + mDefaultFloatViewRotation);
                mFloatView.setTranslationY(mHeaderWaveView.getSinHeight());
//                mFloatView.getLayoutParams().height = mFloatView.getMeasuredHeight();
